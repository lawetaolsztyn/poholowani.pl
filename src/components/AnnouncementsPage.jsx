...
<div className="announcements-list-container"> {/* ZMIANA KLASY */}
  {announcements.map((announcement) => (
    <div key={announcement.id} className="announcement-list-card"> {/* ZMIANA KLASY */}
      ...
      {/* ... reszta zawartości karty ogłoszenia ... */}
