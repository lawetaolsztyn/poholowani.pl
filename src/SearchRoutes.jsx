...
useEffect(() => {
  ...
  `);
    ...
    return (
        <>
            <Navbar />
            {/* Zmieniamy styl inline na klasy CSS */}
            <div className="main-container"> {/* Nowa klasa dla głównego kontenera */}

                <div className="search-form-container"> {/* Nowa klasa dla kontenera formularza */}
                ...
                <div className="map-wrapper"> {/* Nowa klasa dla kontenera mapy */}
                    <MapContext.Provider value={{ center, setCenter, resetTrigger }}>
                        <MapContainer center={center} zoom={6} className="main-map-container" whenCreated={(mapInstance) => { mapRef.current = mapInstance; }}> {/* Dodana klasa */}
                            ...
                            />
                            {center && (<div className="map-cross">+</div>)} {/* Używamy istniejącej klasy map-cross */}
                ...
                <div className="route-slider-wrapper"> {/* Nowa klasa dla kontenera slidera */}
                    <RouteSlider
